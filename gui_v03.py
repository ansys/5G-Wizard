...
################################################################################
## Form generated from reading UI file 'gui_v03.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pd_setup_group.setGeometry(QRect(20, 300, 491, 201))
        ...
        self.multi_run_checkbox.setGeometry(QRect(70, 680, 111, 20))
        self.codebook_group = QGroupBox(Dialog)
        self.codebook_group.setObjectName(u"codebook_group")
        self.codebook_group.setGeometry(QRect(20, 210, 491, 81))
        ...
        self.ignore_beampair = QCheckBox(self.codebook_group)
        self.ignore_beampair.setObjectName(u"ignore_beampair")
        self.ignore_beampair.setGeometry(QRect(30, 50, 421, 20))
        ...
        self.multirun_group.setGeometry(QRect(170, 660, 341, 51))
        ...
        self.output_group.setGeometry(QRect(20, 610, 491, 51))
        ...
        self.cdf_setup_group = QGroupBox(Dialog)
        self.cdf_setup_group.setObjectName(u"cdf_setup_group")
        self.cdf_setup_group.setGeometry(QRect(20, 510, 491, 91))
        self.cdf_setup_group.setFont(font)
        self.cs_input = QComboBox(self.cdf_setup_group)
        self.cs_input.addItem("")
        self.cs_input.setObjectName(u"cs_input")
        self.cs_input.setGeometry(QRect(210, 20, 271, 22))
        self.label_8 = QLabel(self.cdf_setup_group)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(70, 20, 131, 21))
        self.label_8.setFont(font1)
        self.label_8.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.cdf_renorm_input = QComboBox(self.cdf_setup_group)
        ...
        self.label_10 = QLabel(self.cdf_setup_group)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(90, 60, 111, 21))
        self.label_10.setFont(font1)
        self.cdf_dblin_input = QComboBox(self.cdf_setup_group)
        ...
        self.validation_button.setFont(font2)
...
#if QT_CONFIG(tooltip)
        self.codebook_text.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p>The codebook can be defined in a v1 or v2 format. This can automatically be detected. V1 format is a single file, where v2 is several files. With the v2 format, the mapping.csv file should be selected. </p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.codebook_browse.setText(QCoreApplication.translate("Dialog", u"...", None))
#if QT_CONFIG(tooltip)
        self.ignore_beampair.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-weight:700;\">If this box is unchecked,</span> the evaluation of PD will only be performed for the total excitation for each beam, including its pair. For example, if BeamID_0 is paired with BeamID_128, the PD will only be evaulated with BeamID_0 and BeamID_128 turned on. </p><p><span style=\" font-weight:700;\">If this box is checked,</span> the evalulation of PD will be peformed for each individual beam ID, ignoring any possibly beam pairs. For example, if BeamID_0 is paired with BeamID_128, the PD will be evaulated 2 different times, once for only BeamID_0 turned on, once for only BeamID_128 turned on, even if a beam pair is defined, it will be ignored. This can also be achieved within the v1 codebook by specifying -1 as beampair. </p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.ignore_beampair.setText(QCoreApplication.translate("Dialog", u"Ignore Beampair", None))
...
#endif // QT_CONFIG(tooltip)
        self.cdf_setup_group.setTitle(QCoreApplication.translate("Dialog", u"CDF Setup", None))
